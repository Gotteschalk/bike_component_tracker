...
class ComponentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create component" do
    assert_difference('Component.count') do
      post components_url, params: { component: { bike_id: @component.bike_id, comp_name: @component.comp_name, distance_done: @component.distance_done, max_distance: @component.max_distance } }
    end
  ...
  test "should update component" do
    patch component_url(@component), params: { component: { bike_id: @component.bike_id, comp_name: @component.comp_name, distance_done: @component.distance_done, max_distance: @component.max_distance } }
